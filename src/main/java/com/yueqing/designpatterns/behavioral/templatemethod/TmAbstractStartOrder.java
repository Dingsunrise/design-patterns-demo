 ...
 * @date 2022/7/20
 */
public class TmAbstractStartOrder extends AbstractStartOrderTemplate {

    @Override
    protected double calculatePrice(double price) {
        return PriceStrategyFactory.getPriceStrategy(OrderPriceEnum.TMOrder).calculatePrice(price);
    }

    @Override
    protected void ship(Commodity commodity) {
        System.out.println("The "+commodity.getName()+" has been shipped by Tm Express");
    }
